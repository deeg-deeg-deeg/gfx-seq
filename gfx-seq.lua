...
function init()
  ...
  params:add_control("xrow", "Scan Row", controlspec.new(0, 64, "lin", 0, 0, ""))
  
  params:add_control("minn", "Min Note", controlspec.new(0, 127, "lin", 0, 30, ""))
  params:add_control("maxn", "Max Note", controlspec.new(0, 127, "lin", 0, 100, ""))  
  ...
  params:add_control("lfo01target", "LFO01 Target", controlspec.new(1, 11, "lin", 0, 4, ""))
  params:add_control("lfo01amnt", "LFO01 Amount", controlspec.new(0, 100, "lin", 0, 0, ""))
  params:add_control("lfo02target", "LFO02 Target", controlspec.new(1, 11, "lin", 0, 9, ""))
  ...
  params:add_control("wwidth", "X-Width", controlspec.new(0, 127, "lin", 0, 127, ""))
  params:add_control("woff", "Width Offset", controlspec.new(-64, 64, "lin", 0, 0, ""))
  ...
  params:add_control("se_length", "Looplength", controlspec.new(1, 8, "lin", 0, 2, ""))
  params:add_option("se_mode","Mode",{"A", "B"},1) 
  params:add_option("scandir","Scan Direction",{"horiz", "vert"},1) 
  params:add_control("yheight", "Y-height", controlspec.new(0, 63, "lin", 0, 0, ""))

  for k = 1,64 do
    params:add_control("seqnote"..k, "SeqNote"..k, controlspec.new(-1, 127, "lin", 0, math.random(1,127), ""))
  end
